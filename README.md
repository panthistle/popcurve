...
Curves generator add-on for Blender. Developed and tested on Blender 3.6 LTS.  
...
- Click on 'PTDBLNPOPC.zip' and then select 'Download raw file' and save the zip file to your hard drive  

To install the add-on in Blender:
- Start Blender
- Open the 'Preferences...' window from the 'Edit' menu
- In 'Add-ons' tab, click 'Install...', navigate to the folder where you saved the 'PTDBLNPOPC.zip' file and click 'Install Add-on'
- Enable the add-on  
